...
RSpec.describe AdminController, type: :controller do
  before do
    ...
    Auth.destroy_all
    Event.destroy_all
    @auth_test = Auth.create!(name: 'admintest_admin', email: 'admintest_admin@gmail.com', password: '12345678',
                              user_type: 'ADMIN')
    @admin = Producer.create!(name: 'admintest_admin', email: 'admintest_admin@gmail.com')
    @form = Form.create!(producer_id: @admin._id.to_str)
    @event = Event.create!(title: 'test', producer_id: @admin._id.to_str, status: 'ACCEPTING',
