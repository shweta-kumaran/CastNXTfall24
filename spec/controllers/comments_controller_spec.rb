...
RSpec.describe CommentsController, type: :controller do
  ...
  describe 'comments#create' do
    it 'should create comment as client' do
      ...
      expect do
        post :create,
             params: { event_id: @event._id.to_str, client_id: @client._id, slide_id: @slide._id.to_str,
                       content: 'comment controller', owner: @client.name }
    ...
    it 'should not create a new comment as user' do
