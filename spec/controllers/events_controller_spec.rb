...
RSpec.describe EventsController, type: :controller do
  before do
    ...
    @slide = Slide.create(event_id: @event._id, talent_id: @talent._id, curated: false, submission_status: 'UNDER REVIEW',
                          data: '{"name":"aaaa","email":"aaaa@gmail.com","talentName":"aaaa","state":"Kentucky","city":"Ames","paymentLink":"paypal.me/random"}')
