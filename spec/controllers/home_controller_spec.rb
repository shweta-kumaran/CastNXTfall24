...
RSpec.describe HomeController, type: :controller do
  ...
  describe 'home#index' do
    ...
    it 'should automatically login if session is not set' do
      post :signup,
           params: { name: 'hometest_admin', email: 'hometest_admin@gmail.com', password: '12345678',
                     type: 'ADMIN' }
      get :index
  ...
  describe 'home@signup' do
    ...
    it 'should change count if no existing client' do
      expect do
        post :signup,
             params: { name: 'hometest_client', email: 'hometest_client@gmail.com', password: '12345678',
                       type: 'CLIENT' }
    ...
    it 'should change count if no existing talent' do
      expect do
        post :signup,
             params: { name: 'hometest_talent', email: 'hometest_talent@gmail.com', password: '12345678',
                       type: 'USER' }
    ...
    it 'should not change count if email existing' do
      ...
      expect do
        post :signup,
             params: { name: 'hometest_admin', email: 'hometest_admin@gmail.com', password: '12345678',
                       type: 'ADMIN' }
      end.to_not change(Producer, :count)
    end
  end
  describe 'home@login' do
    ...
    it 'failed when not active' do
      Auth.create!(name: 'hometest_admin', email: 'hometest_admin@gmail.com', password: '12345678', user_type: 'ADMIN',
                   is_active: false)
