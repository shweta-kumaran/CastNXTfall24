...
RSpec.describe SlidesController, type: :controller do
  before do
    ...
    @auth_talent2 = Auth.create!(name: 'eventtest_user2', email: 'eventtest_use2r@gmail.com', password: '12345678',
                                 user_type: 'USER')
    @talent2 = Talent.create!(name: 'eventtest_user2', email: 'eventtest_user2@gmail.com')
  ...
  describe 'Slides#create' do
    ...
    it 'should  create if login as user' do
      ...
      post :create,
           params: { event_id: @event._id.to_str,
                     formData: '{"name":"aaaa","email":"aaaa@gmail.com","talentName":"aaaa","state":"Kentucky","city":"Ames","paymentLink":"paypal.me/random"}' }
    ...
    it 'should create if login as admin' do
      ...
      data2 = { @slide._id.to_str => {
        formData: '{"name":"aaaa","email":"aaaa@gmail.com","talentName":"aaaa","state":"Kentucky","city":"Ames","paymentLink":"paypal.me/random"}', curated: false
      } }
      post :create,
           params: { event_id: @event._id.to_str,
                     formData: '{"name":"aaaa","email":"aaaa@gmail.com","talentName":"aaaa","state":"Kentucky","city":"Ames","paymentLink":"paypal.me/random"}', clients: data1, slides: data2 }
      expect(response).to have_http_status(:success)
    end
