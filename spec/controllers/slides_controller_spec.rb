      ...
      data2 = {
        @slide._id.to_str => {
          formData: {
            ...
            city: 'Ames',
            paymentLink: 'paypal.me/random'
          }.to_json, # Convert the Ruby hash to JSON
          curated: false
        }
      }
      ...
      post :create,
           params: {
             ...
             formData: {
               ...
               city: 'Ames',
               paymentLink: 'paypal.me/random'
             }.to_json, # Convert the formData hash to JSON
             clients: data1,  # Assuming data1 is already defined and is the desired format
             slides: data2    # Assuming data2 is already defined and is the desired format
           }
